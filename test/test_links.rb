...
#     @urli_me_valid = UrliMe::Init.new(key: @data['SECRET_KEY'],
#                                       pwd: @data['SECRET_PWD'])
#     @urli_me_invalid = UrliMe::Init.new(key: 'asuhsuahuas',
#                                         pwd: 'asuhuhasuashdudah')
#   end
...
#     resp = @urli_me_valid.update_link(@data['SECRET_TOKEN'],
#                                       @data['SECRET_UP_LINK'])
#     assert_equal resp.response['status'], '200 OK'
#   end
...
#     resp = @urli_me_invalid.update_link(@data['SECRET_TOKEN'],
#                                         @data['SECRET_UP_LINK'])
#     assert_equal resp.response['status'], '401 Unauthorized'
#   end
